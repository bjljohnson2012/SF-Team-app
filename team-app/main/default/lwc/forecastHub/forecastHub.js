...
const SECTIONS = [
    ...
    { id: 'conversion', label: 'Conversion Metrics', subs: [['win', 'Win Rate Truth'], ['ae', 'AE by AE'], ['metrics', 'Metrics']] }
];
...
export default class ForecastHub extends LightningElement {
    ...
    get vMetrics() { return this.isConversion && (this.subConversion === 'metrics' || this.subConversion === 'problems'); }
